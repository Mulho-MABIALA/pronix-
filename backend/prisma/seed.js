  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Scores en direct',
        'Classement des tipsters (top 20)',
        'Comparateur d\'équipes et filtres avancés',
        'Suivi de paris et favoris',
        '3 pronostics détaillés par jour',
        'Chat IA — 3 questions/jour',
        '3 tickets générés par jour',
      ],
    },
    {
      ...
      features: [
        ...
        'Explication IA des value bets',
        'Analyse IA en direct pendant les matchs',
        'Chat IA illimité',
        'Générateur de tickets illimité',
        'Coach IA personnel',
