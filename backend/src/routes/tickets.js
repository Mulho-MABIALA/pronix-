...
const { saveTicket, getTicketHistory, getLastTicketSettings, deleteTicket, getTicketQuota, consumeTicketQuota } = require('../controllers/ticketController');
...
router.get('/last', getLastTicketSettings);
