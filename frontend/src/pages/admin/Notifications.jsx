...
export default function AdminNotifications() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
      <div>
        <h1 className="text-xl font-display font-bold text-ink-1">Notifications Push</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="card-p flex flex-col gap-1">
          ...
          <p className="text-3xl font-display font-bold text-ink-1">{stats?.total ?? '—'}</p>
        </div>
        <div className="card-p flex flex-col gap-1">
          <div className="flex items-center gap-2 text-ink-3 text-xs font-semibold uppercase tracking-wide">
      ...
      {/* ── Modèles rapides ───────────────────────────────────────── */}
      <div className="card-p space-y-3">
        <h2 className="text-sm font-semibold text-ink-1">Modèles rapides</h2>
      ...
      <form onSubmit={handleSubmit} className="card-p space-y-4">
        <h2 className="text-sm font-semibold text-ink-1">Diffusion manuelle</h2>
        ...
        {form.title && (
          <div className="p-3 rounded-xl bg-surface-800 border border-overlay/[0.06]">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-ink-1">{form.title}</p>
