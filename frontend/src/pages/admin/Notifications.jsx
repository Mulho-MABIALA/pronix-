        ...
        <div className="grid grid-cols-2 gap-2">
          {TEMPLATES.map((tpl) => (
            <button
              ...
              className="text-left p-3 rounded-xl border border-white/[0.06] hover:bg-white/[0.04] hover:border-white/[0.1] transition-colors text-sm text-gray-300 font-medium"
            >
              {tpl.label}
            </button>
          ))}
          ...
          <div className="p-3 rounded-xl bg-surface-800 border border-white/[0.06]">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">{form.body}</p>
              </div>
            </div>
          </div>
        )}
